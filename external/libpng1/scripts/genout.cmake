...
set(SRCDIR "/wasm/libpng")
set(BINDIR "/wasm/libpng")

set(AWK "/usr/bin/awk")
set(CMAKE_C_COMPILER "/emsdk_portable/emscripten/tag-1.38.45/emcc")
set(CMAKE_C_FLAGS -O3 -s BINARYEN_TRAP_MODE=clamp -s ALLOW_MEMORY_GROWTH=1 -s USE_PTHREADS=0 -s ASSERTIONS=2)
set(INCDIR "/wasm/libpng")
set(PNG_PREFIX "")
set(PNGLIB_MAJOR "1")
set(PNGLIB_MINOR "6")
